        ...
        <div class="row">
            <div class="hidden-xs hidden-sm col-md-12 col-lg-12" 
                ...
                <div class="news_main">                                        
                    ...
                    <!--Right Col-->
                    <div class="col-md-8 col-lg-8" style="font-family: SourceSansPro-Regular">
                        <form method='POST' 
                              id = "frm1" 
                              name = "frm1" 
                                        ...
                                        <div class ="form-horizontal">
                                            ...
                                            <div class ="form-inline">
                                                <div class ="form-group col-md-4 col-lg-4" 
                                                     style="padding-left: 0px">
                                                    <span for="country" 
                                                          class="col-md-12 col-lg-12 control-label"                                                          
                                                          style="text-align: left; 
                                                                font-family: SourceSansPro-Regular;
                                                                font-size: 17px;
                                                                margin-bottom: 10px">
                                            ...
                                            <div class ="form-group">
                                                <span for="firstname" 
                                                       class="col-md-3 col-lg-3 control-label"
                                                       style="text-align: left; 
                                                              font-family: SourceSansPro-Regular;
                                                              font-size: 17px;
                                                              margin-top: 25px">
...
<script>
    ...
    $(function() {
        $("#birthday" ).datepicker({dateFormat: 'dd-mm-yy',
                                    changeMonth:true,
                                    changeYear: true});
        $( "#birthday" ).datepicker( "option", "yearRange", "1970:" + yearnow );
        $( "#birthday" ).datepicker( "option", "monthNamesShort", 
        [ "Tháng 1", "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5"
            , "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12" ] );
        $( "#birthday" ).datepicker( "option", "dayNamesMin", 
