...
class Category {
    ...
    public static function getCategoriesParent_result() {
        $categories = GetRows('categoriesresult_key,
                            categoriesresult_id,
                            categoriesresult_name,
                            keywordsresult'
                        , 'categoriesresult'
                        , 'categoriesresult_status = 1 AND levelresult = 1 ORDER BY sortresult_order ASC');
        return $categories;
    }
    ...
    public static function getCategoriesSub_result($id_category_parent) {
        $categories_sub = GetRows('categoriesresult_key,
                                categoriesresult_id,
                                categoriesresult_name,
                                keywordsresult'
                            , 'categoriesresult'
                            , 'categoriesresult_status = 1 AND levelresult = 2
                            AND parentresult_id = ' . $id_category_parent . ' ORDER BY sortresult_order ASC');
        return $categories_sub;
    }
    ...
    public static function getCategoryKeyByProductID($product_id) {
        $product = GetRows('category_id', 'product_category', 'product_id = ' . $product_id . ' GROUP BY category_id ORDER BY category_id ASC ');
