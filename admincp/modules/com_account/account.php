<?php
    ...
    if (isset($_POST['btnSub'])) {
        ...
        if (empty($error)) {
            ...
            if ($CF == false) {
                $error.= '<li>' .'Lưu mật khẩu mới thất bại' . '</li>';
            } else {
