...
<form method='POST' enctype='multipart/form-data' id = "frm" name = "frm">
    <div class = "title" style ="text-indent:10px">Quản lý kết quả cuộc thi</div>
    ...
    <div style = "float:left">
        ...
        <div>
            ...
            <div class = "con_list_con" style = "width:50px;background-color:{color};height:30px;"><a href="?show=OptNews_result&id={id}&p={p}&order={oderby}">{lag_edit}</a></div>
    ...
    <input style="{style_display_btAdd}" class = "button" type = "button" value = "Thêm tin" {status} onclick="window.location = './?show=OptNews_result&p={p}&order={oderby}'">
