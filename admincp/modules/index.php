        ...
        switch ($show) {
            ...
            case 'question':
                if (strpos($_SESSION['admin'][3], ';9;') !== false) {
                    include('com_question/ProductList.php');
                } else {
                    ?>
                    <script>
            ...
            case 'OptQuestion':
                if (strpos($_SESSION['admin'][3], ';9;') !== false) {
                    include('com_question/OptProduct.php');
                } else {
                    ?>
                    <script>
                        alert("Bạn không được cấp quyền truy cập trang này!");
            ...
            case 'questionimage':
                if (strpos($_SESSION['admin'][3], ';9;') !== false) {
                    include('com_question_image/ProductList.php');
                } else {
                    ?>
                    <script>
                        alert("Bạn không được cấp quyền truy cập trang này!");
            ...
            case 'OptQuestionImage':
                if (strpos($_SESSION['admin'][3], ';9;') !== false) {
                    include('com_question_image/OptProduct.php');
                } else {
                    ?>
                    <script>
                        alert("Bạn không được cấp quyền truy cập trang này!");
            ...
            case 'catalogue_result':
                if (strpos($_SESSION['admin'][3], ';36;') !== false) {
                    include('com_catalogue_result/ListCatalogue.php');
                } else {
                    ?>
                    <script>
                        alert("Bạn không được cấp quyền truy cập trang này!");
            ...
            case 'CatalogueOpt_result':
                if (strpos($_SESSION['admin'][3], ';36;') !== false) {
                    include('com_catalogue_result/CatalogueOpt.php');
                } else {
                    ?>
                    <script>
                        alert("Bạn không được cấp quyền truy cập trang này!");
            ...
            case 'catalogueTree_result':
                if (strpos($_SESSION['admin'][3], ';36;') !== false) {
                    include('com_catalogue_result/ListCatalogueTree.php');
                } else {
                    ?>
                    <script>
                        alert("Bạn không được cấp quyền truy cập trang này!");
            ...
            case 'newsList_result':
                if (strpos($_SESSION['admin'][3], ';37;') !== false) {
                    include('com_news_result/NewsList.php');
                } else {
                    ?>
                    <script>
                        alert("Bạn không được cấp quyền truy cập trang này!");
            ...
            case 'OptNews_result':
                if (strpos($_SESSION['admin'][3], ';37;') !== false) {
                    include('com_news_result/OptNews.php');
                } else {
                    ?>
                    <script>
                        alert("Bạn không được cấp quyền truy cập trang này!");
