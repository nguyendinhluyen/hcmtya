...
<script type="text/javascript">
    function lookup(inputString) {
        if (inputString.length === 0) {
            ...
            $.post("../include/autoSugAjaxQuestion.php", {queryString: ""+inputString+""}, function (data) {
                if (data.length > 0) {
                    $('#suggestions').show();
...
<form method='POST' enctype='multipart/form-data' id = "frm" name = "frm">
    ...
    <div style = "float:left">			                                    
        ...
        <input class = "button" type = "button" value = "Thêm mới" onclick="window.location = './?show=OptQuestion&order={oderby}'"/>        
        <div class = "title" style = 'width:851px; margin-top: 5px; margin-bottom: 0px'>				
            ...
            <div class = "con_title" style = "width:150px">
                <a href = './?show=question&order=ordernumber&p={p}' style="text-decoration:underline">Thứ tự (tăng)</a>
                <span>&nbsp&nbsp-&nbsp </span>
                <span>
                    <a href = './?show=question&order=ordernumber_desc&p={p}'style = "text-decoration:underline">(giảm)</a>
                </span>
            </div>
            <div class = "con_title" style = "width:350px;">
                <a href = './?show=question&order=name&p={p}' style="text-decoration:underline">{questionname} (a->z)</a>
                <span>&nbsp&nbsp-&nbsp </span>
                <span>
                    <a href = './?show=question&order=name_desc&p={p}'style = "text-decoration:underline">(z->a)</a>
                </span>
            </div>
            <div class = "con_title" style = "width:90px;">
                <a href = './?show=question&order=status&p={p}'style='text-decoration:underline'>{lag_status}</a>
            </div>

            <div class = "con_title" style = "width:110px;border:0px;">
                <a href = './?show=question&order=dateadd&p={p}' style="text-decoration:underline">Ngày (cũ)</a>
                <span>&nbsp&nbsp-&nbsp </span>
                <span>
                    <a href = './?show=question&order=dateadd_desc&p={p}'style = "text-decoration:underline">(mới)</a>
                </span>
            </div>
        </div>                                                            
        ...
        <div>
            ...
            <div class = "con_list_con" style = "width:50px;background-color:{color};height:50px;">
                <a href="?show=question&action=del&id={id}&p={p}&order={oderby}" 
            ...
            <div class = "con_list_con" style = "width:50px;background-color:{color};height:50px;">
                <a href="?show=OptQuestion&id={id}&p={p}&order={oderby}">{lag_edit}</a>
            </div>
