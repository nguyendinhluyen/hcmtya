...
<div class="user_left">					  
    <table style="text-align: left; float:left; margin-top:10px" border="0px;">
        ...
        <tr>
            <td align="center">
                <img alt="" src="../../upload/avatar/{avatar}" width="200px">
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <div class="newsPersonal_inside">
            <div class="group_listing_input" id="group_listing_input">								
                ...
                <div class="listing_input">
                    ...
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">
                            <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: Thí sinh</b>
                        </label>
                    </div>
                </div>                                    
                <div class="listing_input">
                    <div class="post_label_container" style="width: 160px">
                        <label class="postLabel" 
                               style="width: 150px; margin-bottom:10px">Ngày thi trắc nghiệm</label>
                    </div>
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">
                            <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {start_time_exam}</b>
                        </label>
                    </div>
                </div>                                   	
                <div class="listing_input">
                    <div class="post_label_container" style="width: 160px">
                        <label class="postLabel" 
                               style="width: 150px; margin-bottom:10px">Bộ đề trắc nghiệm</label>
                    </div>
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">
                            <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {exam_category}</b>
                        </label>
                    </div>
                </div>                                   	
                <div class="listing_input">
                    <div class="post_label_container" style="width: 160px">
                        <label class="postLabel"
                               style="width: 150px; margin-bottom:10px">Điểm trắc nghiệm</label>
                    </div>
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">
                            <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {score_exam}</b>
                        </label>
                    </div>
                </div>
                <div class="listing_input">
                    <div class="post_label_container" style="width: 160px">
                        <label class="postLabel" 
                               style="width: 150px; margin-bottom:10px">Ngày thi tự luận</label>
                    </div>
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">
                            <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {start_time_exam_question}</b>
                        </label>
                    </div>
                    <div class="post_label_container" style="width: 160px">
                        <label class="postLabel" 
                               style="width: 150px; margin-bottom:10px">Đề thi tự luận</label>
                    </div>
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">
                            <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {question}</b>
                        </label>
                    </div>
                    <div class="post_label_container" style="width: 160px">
                        <label class="postLabel" 
                               style="width: 150px; margin-bottom:10px">Đường dẫn tự luận</label>
                    </div>
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">
                            <b>: </b>
                            <b style="color:#AA1F00; font-size:14px; font-family:Cambria; text-decoration: underline">
                                <a href="../../upload/question/{exam_answer}" target="_blank">{exam_answer} </a>
                            </b>
                        </label>
                    </div>
                </div>
                <div class="listing_input">
                    <div class="post_label_container" style="width: 160px">
                        <label class="postLabel" 
                               style="width: 150px; margin-bottom:10px">Ngày thi ảnh luận</label>
                    </div>
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">
                            <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {start_time_exam_question_image}</b>
                        </label>
                    </div>
                    <div class="post_label_container" style="width: 160px">
                        <label class="postLabel" 
                               style="width: 150px; margin-bottom:10px">Đề thi ảnh luận</label>
                    </div>
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">
                            <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {question_image}</b>
                        </label>
                    </div>
                    <div class="post_label_container" style="width: 160px">
                        <label class="postLabel" 
                               style="width: 150px; margin-bottom:10px">Đường dẫn ảnh luận</label>
                    </div>
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">
                            <b>: </b>
                            <b style="color:#AA1F00; font-size:14px; font-family:Cambria; text-decoration: underline">
                                <a href="../../upload/question_image/{exam_answer_image}" target="_blank">{exam_answer_image} </a>
                            </b>
                        </label>
                    </div>
                </div>
