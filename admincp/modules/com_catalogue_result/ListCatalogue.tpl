...
<form method='POST' enctype='multipart/form-data' id = "frm" name = "frm">
    ...
    <div><img src ="../style/images/folderopen.gif"><a href = "./?show=catalogueTree_result">{viewastree}</a></div>
    ...
    <div style = "float:left">
        <div class = "title" style = 'width:851px'>
            ...
            <div class = "con_title" style = "width:170px ;">
                <a href = './?show=catalogue_result&order=name&p={p}' style="text-decoration:underline">{lag_cats_name}(a->z)</a><span>&nbsp&nbsp-&nbsp </span><span><a href = './?show=catalogue_result&order=name_desc&p={p}'style = "text-decoration:underline">(z->a)</a> </span></div>
            <div class = "con_title" style = "width:170px;"><a href = './?show=catalogue_result&order=catalogue_result&p={p}' style="text-decoration:underline">{ofcatalogue}</a><span>&nbsp&nbsp&nbsp </span><span><a href = './?show=catalogue_result&order=catalogue_result_desc&p={p}'style = "text-decoration:underline"></a> </span></div>
            <div class = "con_title" style = "width:55px">                  
                {lag_order}
            </div>				
            <div class = "con_title" style = "width:65px;"><a href = './?show=catalogue_result&order=status&p={p}'style='text-decoration:underline'>{lag_status}</a></div>				                
            <div class = "con_title" style = "width:141px;border:0px;"><a href = './?show=catalogue_result&order=dateadd&p={p}' style="text-decoration:underline">{lag_date_create} (cũ)</a><span>&nbsp&nbsp-&nbsp </span><span><a href = './?show=catalogue_result&order=dateadd_desc&p={p}'style = "text-decoration:underline">(mới)</a> </span></div>                                                
            <div class = "con_title" style = "width:100px;border:0px;"><a href = './?show=catalogue_result&order=datemodifiled&p={p}' style="text-decoration:underline">Sửa (cũ)</a><span>&nbsp&nbsp-&nbsp </span><span><a href = './?show=catalogue_result&order=datemodifiled_desc&p={p}'style = "text-decoration:underline">(mới)</a> </span></div>
        </div>
        <div>
            <!--BEGINLIST_CATALOGUE-->
            <!--BEGIN_CATALOGUE-->
            ...
            <div class = "con_list_con" style = "width:50px;background-color:{color};height:30px;"><a href="./?show=catalogue_result&action=del&id={id}&p={p}&order={orderby}" onclick="return confirm('{del_confirm} ?');">{lag_delete}</a></div>
            <div class = "con_list_con" style = "width:50px;background-color:{color};height:30px;"><a href="./?show=CatalogueOpt_result&id={id}&p={p}&order={orderby}">{lag_edit}</a></div>                
    ...
    <input class = "button" type = "button" value = "{add_cat}" onclick="window.location = './?show=CatalogueOpt_result{type_of_order}&p={page}'">
</form>
