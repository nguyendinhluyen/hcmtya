...
<script>
    ...
    function makeEditable(id, opt) {
        ...
        Event.observe(id, 'mouseover', function () {
            showAsEditable($(id))}, false);
        Event.observe(id, 'mouseout', function () {
            showAsEditable($(id), true)}, false);
    }
    ...
    <div style = "float:left">
        <div class = "title" style = 'width:851px'>
            ...
            <div class = "con_title" style = "width:170px ;">
                <a href = './?show=catalogue&order=name&p={p}'
                    style="text-decoration:underline">{lag_cats_name} (a->z)
                </a>
                <span>&nbsp&nbsp-&nbsp </span>
                <span>
                    <a href = './?show=catalogue&order=name_desc&p={p}'style = "text-decoration:underline">(z->a)</a>
                </span>
            </div>                                
            <div class = "con_title" style = "width:170px;">
                <a href = './?show=catalogue&order=catalogue&p={p}' 
                                                               style="text-decoration:underline">{ofcatalogue}</a><span>&nbsp&nbsp&nbsp </span><span><a href = './?show=catalogue&order=catalogue_desc&p={p}'style = "text-decoration:underline"></a> </span></div>                
